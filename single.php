    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
        ...
        <div class="lg:col-span-7">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-3 mt-1">
                                ...
                                <?php if(get_the_author_meta('linkedin')): ?>
                                    <a href="<?php echo esc_url(get_the_author_meta('linkedin')); ?>" class="text-slate-300 hover:text-blue-600 transition-colors" target="_blank">
                            ...
                            <div class="mt-2 flex items-center gap-2">
                                <span class="text-[9px] font-bold text-slate-400 uppercase tracking-tighter">Publicado em <?php the_date(); ?></span>
                                <?php if ( get_the_modified_date() != get_the_date() ) : ?>
                                    <span class="w-1 h-1 bg-slate-300 rounded-full"></span>
                                    <span class="text-[9px] font-black text-emerald-500 uppercase tracking-tighter">Atualizado em <?php the_modified_date(); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="article-content prose prose-slate dark:prose-invert max-w-none text-lg leading-relaxed text-slate-700 dark:text-slate-300">
                ...
                <!-- Showcase de Afiliados (via Plugin Shortcode) -->
